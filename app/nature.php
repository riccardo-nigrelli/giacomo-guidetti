      ...
      <div style='padding: 4px;' class='text-center col-lg-4 col-md-4 col-sm-12'>
        <a href='./albums/nature/cigno.JPG' class='gallery-link'>
          <figure class='gallery-image'>
            ...
            <figcaption>Swan portrait</figcaption>
          </figure>
        </a>
      ...
      <div style='padding: 4px;' class='text-center col-lg-12 col-md-12 col-sm-12'>
        <a href='./albums/nature/monti.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            ...
            <figcaption>Mottarone landscape</figcaption>
          </figure>
        </a>
      </div>
    </div>
    ...
    <div class='row'>
      ...
      <div style='padding: 4px;' class='text-center col-lg-4 col-md-4 col-sm-12'>
        <a href='./albums/nature/Scogliera_gozo.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            <img style='padding-bottom: 8px;' src='./albums/nature/Scogliera_gozo.jpg' alt=''
              class='gallery-image img-fluid'>
            <figcaption>Gozo's salt pools</figcaption>
          </figure>
        </a>
        <a href='./albums/nature/Capra.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            <img src='./albums/nature/Capra.jpg' alt='' class='img-fluid'>
            <figcaption>Animal Farm</figcaption>
          </figure>
        </a>
      </div>
      ...
      <div style='padding: 4px;' class='text-center col-lg-4 col-md-4 col-sm-12'>
        ...
        <a href='./albums/nature/Sugo_vaso.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            ...
            <figcaption>He is Sugo</figcaption>
          </figure>
        </a>
      </div>
      ...
      <div style='padding: 4px;' class='text-center col-lg-4 col-md-4 col-sm-12'>
        <a href='./albums/nature/Formazza_neve.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            <img style='padding-bottom: 8px;' src='./albums/nature/Formazza_neve.jpg' alt=''
              class='gallery-image img-fluid'>
            <figcaption>Lonely church in Val Formazza</figcaption>
          </figure>
        </a>
        <a href='./albums/nature/Cane_mottarone.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            ...
            <figcaption>Doggo snout</figcaption>
          </figure>
        </a>
      </div>
      ...
      <div style='padding: 4px;' class='text-center col-lg-4 col-md-4 col-sm-12'>
        ...
        <a href='./albums/nature/Gatti_bosco.jpg' class='gallery-link'>
          <figure class='gallery-image'>
            ...
            <figcaption>Some kittens in the wood</figcaption>
          </figure>
        </a>
      </div>
