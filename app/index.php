...
<head>
	...
	<meta name="description" content="Giacomo Guidetti Portfolio">
	...
	<title>Giacomo Guidetti | Photographer</title>
...
<body>
  <div class="home container-fluid h-100">
		<div class="row h-100 justify-content-center align-items-center">
			<div class="col-md-12 text-center my-auto">
				<h1 class="font-cinzel font-70 color-white">Giacomo Guidetti</h1>
				<h4 class="font-cinzel font-24 color-white">PHOTOGRAPHY</h4>

				<button class="font-18 btn btn-outline-light m-top-60" type="button" 
					onclick="document.location.href='portfolio.php';">View More
				</button>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="p-m-20 col-xs-auto text-center" style="font-size:20px;">
